...
- One or more raw research files, including but not limited to:
  - `Shopper_Research.md` (unstructured or semi‑structured)
...
You may add subsections as needed, but **do not change the top‑level section numbers or names**.
...
- Emphasize:
  ...
  - High‑level capabilities (accessibility, OCR, routing, overlays, wearables)
...
- Explain:
  ...
  - L2CAP for high‑bandwidth streaming
- Clarify:
...
> **Note:**  
> This system has elevated privileges and must be treated as a high‑sensitivity component.
