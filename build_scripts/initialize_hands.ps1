# ---------------------------------------------------------
# Nikolai 0.3 – Hands Initialization (Fresh Build)
...
# Constraint Definitions – Nikolai 0.3
...
# Architecture Rules – Nikolai 0.3
...
Write-Host "Nikolai 0.3 hands initialized — mechanical layer ready."