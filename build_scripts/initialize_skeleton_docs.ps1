# ---------------------------------------------------------
# Nikolai 0.3 – Skeleton Initialization (Fresh Build)
# Populates architecture, memory, and error model documents.
# Enforces VS Code–friendly Markdown spacing.
# ---------------------------------------------------------
...
# Runtime Architecture – Nikolai 0.3
...
Write-Host "Nikolai 0.3 skeleton initialized — bones are in place."